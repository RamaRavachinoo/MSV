    ...
    return (
        ...
        >
            <div className="p-4 border-b border-gray-100">
                ...
                <p className="text-xs text-gray-400 mt-0.5">{entries.length} bloque{entries.length !== 1 ? 's' : ''}</p>
            </div>
                            ...
                            >
                                ...
                                {entriesByDay[day]?.map(entry => {
                                    ...
                                    return (
                                        <div
                                            key={entry.id}
                                            className="absolute left-0.5 right-0.5 rounded-lg px-1.5 py-1 overflow-hidden cursor-pointer group transition-all hover:shadow-md hover:z-10"
                                            style={{
                                                ...style,
                                        ...
                                        >
                                            ...
                                            <div className="absolute top-0.5 right-0.5 hidden group-hover:flex gap-0.5">
                                                <button
                                                    ...
                                                    className="p-1 rounded bg-white/90 shadow-sm hover:bg-blue-50"
                                                >
